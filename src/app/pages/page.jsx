...
export default function Pages() {
  return (
    <div>
      <Head>
        <title>Pages Us - Your App Name</title>
        <meta
          name="description"
          content="Learn more pages Your App Name - the ultimate destination for creating professional resumes."
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <h1 className="text-3xl font-bold mb-4 text-center">Pages Us</h1>
      ...
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Pages Us</h2>
